  ...
  function(Primo, $scope) {
    ...
    var Q,P,mensagemC,e,d,n,z;
      ...
      */
      ...
      mensagemC = new BigNumber(value);
      var d = new BigNumber($scope.d);
      var n = new BigNumber($scope.n);
      //  $scope.e = 35;
      // $scope.d  = 13;
      // var mensagemCpwup = mod(Math.pow(mensagemC, $scope.d), $scope.n);
      var mensagemCpwup = mensagemC.pow($scope.d);
      console.log("pwup = " + mensagemCpwup.mod($scope.n));
